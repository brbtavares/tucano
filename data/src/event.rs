...
use markets::{exchange::ExchangeId, instrument::market_data::MarketDataInstrument};
...
///
/// See [`crate::subscription`] for all existing Toucan Market event variants.
///
/// ### Examples
...
/// Available kinds of normalised Toucan [`MarketEvent<T>`](MarketEvent).
///
/// ### Notes
