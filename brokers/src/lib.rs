...
mod integration_tests {
    ...
    fn cost_model_applied_to_certified_registry() {
        ...
        let win_cost = custom
            .cost_model
            .cost(&"WINZ25".into(), dec!(100_000), dec!(1)); // 0.0005 * 100k = 50
        assert_eq!(win_cost, dec!(50));
        let other_cost = custom
            .cost_model
            .cost(&"PETR4".into(), dec!(10_000), dec!(1)); // default fixed 1
