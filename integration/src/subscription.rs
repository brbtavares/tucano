...
///
/// For example, `Toucan-Data` uses this identifier to associate received data structures from the
/// execution with the original `Toucan-Data` `Subscription` that was actioned over the socket.
///
