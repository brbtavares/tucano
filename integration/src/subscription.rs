...
///
/// For example, `Data` uses this identifier to associate received data structures from the
/// execution with the original `Data` `Subscription` that was actioned over the socket.
///
